    ...
    <div id="info">
        <div class="container-fluid py-3 px-5">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                ...
                <div class="col-md-2 mx-auto p-2">
                    <h4>Kontak Kami</h4>
                    <ul class="list-group">
                        <li style="list-style-type: none">
                            <a class="text-decoration-none text-dark" href="">+628xxxxx</a>
                        </li>
                        <li style="list-style-type: none">
                            <a class="text-decoration-none text-dark" href="">amikypatxxxx@gmail.com</a>
                        </li>
                      </ul>
                </div>
                <div class="col-md-2 mx-auto p-2">
